...
void AppClass::Display(void)
{
	...
	m_pMeshMngr->AddSphereToQueue(glm::translate(m_BoundCone.v3Position) * glm::scale(vector3(m_BoundCone.fRadius * 2)), RERED, WIRE);
	m_pMeshMngr->AddSphereToQueue(glm::translate(m_BoundTorus.v3Position) * glm::scale(vector3(m_BoundTorus.fRadius * 2)), RERED, WIRE);
